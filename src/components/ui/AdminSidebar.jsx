...
const AdminSidebar = ({ isCollapsed = false, onToggleCollapse }) => {
  ...
  const sidebarSections = [
    ...
    },
    {
      ...
      items: [
        ...
        {
          label: "Manage Roles",
          path: "/admin-user-management", // ✅ NEW PAGE
          icon: "Shield",
          description: "Change roles & permissions",
        },
        {
          label: "Sales Agents",
  ...
  return (
    <aside
      className={`fixed left-0 top-16 bottom-0 z-40 bg-card border-r border-border luxury-shadow-medium transition-all duration-300 ${
